<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DisplayBooks.aspx.cs" Inherits="DisplayBooks" %>
...
<body>
    ...
    <div class="record">
    <h1>Display Books Details</h1>
    
        <asp:GridView ID="GridView1" runat="server" Width="1300px" ForeColor="White">
        </asp:GridView>
    
        <br />
        <asp:Button ID="Button1" runat="server" class="home-btn" onclick="Button1_Click" 
